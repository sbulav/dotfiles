{
  services.skhd = {
    ...
    skhdConfig = ''
       ...
       alt + down : yabai -m space --focus kitty
       ...
       # Terminal
       alt - x : open -a "/Users/sab/.nix-profile/bin/kitty"
      # pgrep -f "kitty" \
      #   && osascript -e 'tell application "kitty" to create window with default profile' \
      #   || open -a "/Users/sab/.nix-profile/bin/kitty"
       ...
       # Restart
       alt + shift - r : pkill skhd && pkill yabai
    '';
  };
}
